...
namespace Steeltoe.Initializr.Services
{
    ...
    {
        public static readonly Guid FactoryId = new Guid("8C19221B-DEA3-4250-86FE-2D4E189A11D2"); // Make new guids for Initializr
        public static readonly Guid ZipFactoryId = new Guid("94E92610-CF4C-4F6D-AEB6-9E42DDE1899D"); // Make new guids for Initializr
        ...
        private void EnsureLoaded()
        {
            ...
            using (Timing.Over(_environmentSettings.Host, "Init Mount Point manager"))
                _mountPointManager = new InitializrMountPointManager(_environmentSettings, _componentManager);
        ...
        private IEnumerable<MountPointInfo> GetAllMountPoints()
        {
        ...
        private IEnumerable<MountPointInfo> FindMountPointsToScan(bool forceRebuild)
        {
            ...
            foreach (TemplateInfo template in allTemplates)
            {
                ...
                if (mountPoint.MountPointFactoryId != FactoryId)
                {
                    continue;
                }
